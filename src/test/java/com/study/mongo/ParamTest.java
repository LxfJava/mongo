...
//
//import com.study.mongo.business.pojo.ServiceParam;
...
//  @Test
//  void test01() {
//    List<ServiceParam> all = paramService.getAll();
//    System.out.println("========================================================");
...
//  void test02() {
//    for (int i = 0; i < 5; i++) {
//      ServiceParam param = new ServiceParam("0" + i, "Name" + i, "val" + i, "remarks" + i);
...
//  @Test
//  void test03() {
//    ServiceParam param = new ServiceParam("00", "Name", "val", "remarksTestAddOr");
//    paramService.updateParam(param);
//    ServiceParam all = paramService.getParamById("00");
//    System.out.println("========================================================");
//    System.out.println(all);
//    System.out.println("========================================================");
//  }
